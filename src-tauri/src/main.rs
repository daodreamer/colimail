...
use commands::{
    ...
    get_app_user, get_attachment_size_limit, get_current_log_file, get_encryption_status,
    ...
    read_log_file, read_recent_logs, reply_email, save_account_config, save_attachment_to_file,
    save_draft, send_email, set_minimize_to_tray, set_notification_enabled, set_secure_storage,
